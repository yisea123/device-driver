		...
		struct pwm_device *pwm, int duty_ns, int period_ns) 
{
	...
	//printk("fpga_pwm_config duty_ns=%d period_ns=%d clk_period=%d\n", duty_ns, period_ns, fpgapwm->clk_period);
	value = (duty_ns/fpgapwm->clk_period) & 0xffff;
	//printk("fpga_pwm_config—— reg_pulsewidth:reg=%x addr=%x  value=%x\n", 
         //      (u32)fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_pulsewidth, 
         //      (u32)(fpgapwm->mmio_base + fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_pulsewidth), 
        //       value);
        //printk("fpga_pwm_config chan=%d addr=%x, reg_pulsewidth=%x, ", pwm->hwpwm, fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_pulsewidth, value);
	...
	//printk("fpga_pwm_config—— reg_period:reg=%x addr=%x  value=%x\n", 
        //       (u32)fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_period, 
        //       (u32)(fpgapwm->mmio_base + fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_period),
        //        value);
        //printk(" chan=%d addr=%x, reg_period=%x\n", pwm->hwpwm, fpgapwm->fpga_pwm_chans[pwm->hwpwm].reg_period, value);
